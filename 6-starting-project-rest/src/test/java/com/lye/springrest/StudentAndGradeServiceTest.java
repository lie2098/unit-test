...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService() {
        ...
        studentService.createStudent("Chad", "Darby", "chad.darby@demo.com");

        CollegeStudent student = studentDao.findByEmailAddress("chad.darby@demo.com");

        assertEquals("chad.darby@demo.com", student.getEmailAddress(), "find by email");
    }
    ...
    public void studentInformationService() {
        ...
        assertEquals("Lie", gradebookCollegeStudentTest.getFirstname());
        assertEquals("Lye", gradebookCollegeStudentTest.getLastname());
        assertEquals("lie.lye@demo.com", gradebookCollegeStudentTest.getEmailAddress());
